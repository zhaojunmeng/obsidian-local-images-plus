        ...
        if (embeds) {
          ...
          for (let el of embeds) {
            ...
            if ((this.newfCreated.indexOf(el.link) != -1 || (obsmdir != "" && (this.newfCreated.includes(oldpath) || this.newfCreated.includes(el.link)))) &&
              ...
              const oldBinData = await readFromDisk(pathJoin([this.app.vault.adapter.basePath, oldpath]))
              ...
              if (await this.app.vault.adapter.exists(newpath)) {
                ...
                if (newBinData != null) {
                  ...
                  newFMD5 = md5Sig(await readFromDisk(pathJoin([this.app.vault.adapter.basePath, newpath])))
                }
